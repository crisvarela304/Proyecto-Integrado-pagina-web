...
class Examen(models.Model):
    ...
    curso = models.ForeignKey('academico.Curso', on_delete=models.CASCADE, related_name='examenes')
    asignatura = models.ForeignKey('academico.Asignatura', on_delete=models.CASCADE, related_name='examenes')
